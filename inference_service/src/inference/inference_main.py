...
python inference_main.py --image_path ../label/data/images/ --model_path ./models/FS_model_02/saved_model/ --label_path ./annotations/label_map.pbtxt --output_dir ./prediction/
